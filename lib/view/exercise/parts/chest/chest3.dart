...
class Chest3 extends StatefulWidget {
  ...
  @override
  State<Chest3> createState() => _Chest3();
}

class _Chest3 extends State<Chest3> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/chest/chest3.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "Kneel on the floor. Extend arms and put hands shoulder-width apart on the floor in front of you. Tighten abs while you bend arms, lowering your torso until chest grazes the floor. Push torso back up by straightening arms.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
