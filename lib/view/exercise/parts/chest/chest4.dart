...
class Chest4 extends StatefulWidget {
  ...
  @override
  State<Chest4> createState() => _Chest4();
}

class _Chest4 extends State<Chest4> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/chest/chest4.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "Instead of having your hands and fingers pointing forward, as they do with a standard pushup, your hands are flat, but with your fingers pointing back toward your feet. This variation gives your biceps an extra challenging workout.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
