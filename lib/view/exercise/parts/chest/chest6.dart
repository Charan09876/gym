...
class Chest6 extends StatefulWidget {
  const Chest6({super.key});

  @override
  State<Chest6> createState() => _Chest6();
}

class _Chest6 extends State<Chest6> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/chest/chest6.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "Sit on the edge of a bench or chair, hands supporting your weight. Position your feet away from the bench, legs straight and heels on the floor. Lower yourself until your upper arms are parallel to the ground, then push back up.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
