...
class Vcrunch extends StatefulWidget {
  const Vcrunch({super.key});

  @override
  State<Vcrunch> createState() => _Vcrunch();
}

class _Vcrunch extends State<Vcrunch> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/abs/vcrunch.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "Lie on your right side with your legs fully extended and your left hand behind your head. 2. Raise both legs and your torso simultaneously, try touching your left knee with your left elbow and squeeze the abs.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
