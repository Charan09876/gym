...
class Cardio6 extends StatefulWidget {
  const Cardio6({super.key});

  @override
  State<Cardio6> createState() => _Cardio6();
}

class _Cardio6 extends State<Cardio6> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Cardio/cardio6.gif",
