...
class Cardio2 extends StatefulWidget {
  const Cardio2({super.key});

  @override
  State<Cardio2> createState() => _Cardio2();
}

class _Cardio2 extends State<Cardio2> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Cardio/cardio2.gif",
