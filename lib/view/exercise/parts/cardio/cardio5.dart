...
class Cardio5 extends StatefulWidget {
  const Cardio5({super.key});

  @override
  State<Cardio5> createState() => _Cardio5();
}

class _Cardio5 extends State<Cardio5> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Cardio/cardio5.gif",
