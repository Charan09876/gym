...
class Cardio4 extends StatefulWidget {
  const Cardio4({super.key});

  @override
  State<Cardio4> createState() => _Cardio4();
}

class _Cardio4 extends State<Cardio4> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Cardio/cardio4.gif",
