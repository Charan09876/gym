...
class Cardio1 extends StatefulWidget {
  const Cardio1({super.key});

  @override
  State<Cardio1> createState() => _Cardio1();
}

class _Cardio1 extends State<Cardio1> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Cardio/cardio1.gif",
