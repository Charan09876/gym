...
class Shoulder5 extends StatefulWidget {
  const Shoulder5({super.key});

  @override
  State<Shoulder5> createState() => _Shoulder5();
}

class _Shoulder5 extends State<Shoulder5> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/shoulder/shoulder.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "Exhale and raise your shoulders slowly without bending your elbows, as if you're shrugging your shoulders. Keep your hands perpendicular to the floor throughout the exercise.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
