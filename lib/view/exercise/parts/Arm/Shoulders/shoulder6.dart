...
class Shoulder6 extends StatefulWidget {
  const Shoulder6({super.key});

  @override
  State<Shoulder6> createState() => _Shoulder6();
}

class _Shoulder6 extends State<Shoulder6> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/shoulder/shoulder6.gif",
