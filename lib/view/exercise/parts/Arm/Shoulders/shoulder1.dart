...
class Shoulder1 extends StatefulWidget {
  ...
  @override
  State<Shoulder1> createState() => _Shoulder1();
}

class _Shoulder1 extends State<Shoulder1> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/shoulder/shoulder1.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  " The Arnold press is a dumbbell shoulder press variation that involves wrist rotation to target all three deltoids. While the posterior, medial, and anterior deltoids perform the bulk of this move, the triceps, upper chest, and traps are also involved.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
