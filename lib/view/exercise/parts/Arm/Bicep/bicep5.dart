...
class Bicep5 extends StatefulWidget {
  const Bicep5({super.key});

  @override
  State<Bicep5> createState() => _Bicep5();
}

class _Bicep5 extends State<Bicep5> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/bicep/biceps5.gif",
