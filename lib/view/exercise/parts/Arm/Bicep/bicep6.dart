...
class Bicep6 extends StatefulWidget {
  const Bicep6({super.key});

  @override
  State<Bicep6> createState() => _Bicep6();
}

class _Bicep6 extends State<Bicep6> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/bicep/biceps6.gif",
