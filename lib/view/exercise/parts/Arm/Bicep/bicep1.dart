...
class Bicep1 extends StatefulWidget {
  ...
  @override
  State<Bicep1> createState() => _Bicep1();
}

class _Bicep1 extends State<Bicep1> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/bicep/biceps1.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "To do a biceps curl with a dumbbell, hold a dumbbell with your palm facing upward. Slowly curl the weight up by bending your elbow, keeping your elbow close to your body.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
