...
class Bicep2 extends StatefulWidget {
  ...
  @override
  State<Bicep2> createState() => _Bicep2();
}

class _Bicep2 extends State<Bicep2> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/bicep/biceps2.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "Your arms should be pressed against the pads when you sit on the machine. Now grab the handles with your hands facing upwards. Slowly curl the forearms until you squeeze the biceps at the top of the movement. Return your arms to the starting point.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
