...
class Tricep6 extends StatefulWidget {
  const Tricep6({super.key});

  @override
  State<Tricep6> createState() => _Tricep6();
}

class _Tricep6 extends State<Tricep6> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/tricep/triceps6.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "Stand a few feet away from a wall. Place your hands just wider than your shoulders on the wall. With your arms parallel to your sides, bend your elbows and lower your body towards the wall until your elbows are at 90 degree angles. Return and repeat, making sure your back is kept straight",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
