...
class Tricep1 extends StatefulWidget {
  ...
  @override
  State<Tricep1> createState() => _Tricep1();
}

class _Tricep1 extends State<Tricep1> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/tricep/triceps1.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "Lift the dumbbell above your head so that your arms are extended, and your palms are facing the ceiling. Begin the reps by bending at the elbow to lower the dumbbell behind your head. Keep your upper arms in the same place, only allowing your forearms to move.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
