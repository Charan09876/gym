...
class Tricep5 extends StatefulWidget {
  const Tricep5({super.key});

  @override
  State<Tricep5> createState() => _Tricep5();
}

class _Tricep5 extends State<Tricep5> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/Arm/tricep/triceps5.gif",
