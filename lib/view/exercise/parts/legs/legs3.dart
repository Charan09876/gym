...
class Legs3 extends StatefulWidget {
  ...
  @override
  State<Legs3> createState() => _Legs3();
}

class _Legs3 extends State<Legs3> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "A suitcase carry is a unilateral-loaded carry. In other words, you carry a weight in one hand and walk a set distance. It's a good all-round exercise that targets these muscles: core muscles like the rectus abdominis and transverse abdominis.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
