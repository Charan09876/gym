...
class Legs6 extends StatefulWidget {
  const Legs6({super.key});

  @override
  State<Legs6> createState() => _Legs6();
}

class _Legs6 extends State<Legs6> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "They are performed by lying on the side with support coming from one hand placed on the ground and the opposite foot placed on the ground in front of the lower leg. With the top leg slightly flexed and resting, the bottom leg is abducted upwards against gravity and relaxed down to the ground.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
