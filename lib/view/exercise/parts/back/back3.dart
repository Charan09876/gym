...
class Back3 extends StatefulWidget {
  ...
  @override
  State<Back3> createState() => _Back3();
}

class _Back3 extends State<Back3> {
  var cal = 0;
  var time = 0;
  var btn_text = "Start";
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                "images/exercise/back/back3.gif",
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 30),
                child: Text(
                  "side-to-side pull-up is a calisthenics exercise that primarily targets the lats and to a lesser degree also targets the shoulders, biceps, forearms and middle back. The only side-to-side pull-up equipment that you really need is the following: chin-up bar.",
                  style: TextStyle(
                      color: TColor.darkgray,
                      fontFamily: "Poppins",
                      fontSize: 15),
